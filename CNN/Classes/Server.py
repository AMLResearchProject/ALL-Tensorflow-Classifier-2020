...
# Description:   Server functions for the Acute Lymphoblastic Leukemia Tensorflow CNN 2020.
# License:       MIT License
...
class Server():
    ...
    Server functions for the Acute Lymphoblastic Leukemia Tensorflow CNN 2020.
    """
