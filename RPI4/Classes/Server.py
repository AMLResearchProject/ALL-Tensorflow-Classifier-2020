...
# Contributors:
# Title:         Server class
# Description:   Server functions for the Acute Lymphoblastic Leukemia Tensorflow CNN 
#                For Raspberry Pi 4.
# License:       MIT License
...
class Server():
    ...
    Server functions for the Acute Lymphoblastic Leukemia Tensorflow CNN For Raspberry Pi 4.
    """
