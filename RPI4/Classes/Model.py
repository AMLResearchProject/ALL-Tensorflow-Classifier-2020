...
# Contributors:
# Title:         Model class
# Description:   Model functions for the Acute Lymphoblastic Leukemia Tensorflow CNN 
#                For Raspberry Pi 4.
# License:       MIT License
...
class Model():
    ...
    Model functions for the Acute Lymphoblastic Leukemia Tensorflow CNN For Raspberry Pi 4.
    """
